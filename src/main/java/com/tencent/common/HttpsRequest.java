...
public class HttpsRequest implements IServiceRequest{
    ...
    public HttpsRequest(String certLocalPath,String certPassword) throws UnrecoverableKeyException, KeyManagementException, NoSuchAlgorithmException, KeyStoreException, IOException {
    	setRequestConfig(certLocalPath,certPassword);
    }
    
    private void setRequestConfig(String certLocalPath,String certPassword) throws IOException, KeyStoreException, UnrecoverableKeyException, NoSuchAlgorithmException, KeyManagementException {
    	log.info("L001");
    	log.info(certLocalPath);
        KeyStore keyStore = KeyStore.getInstance("PKCS12");
        log.info("L002");
        File cert = new File(certLocalPath);
        log.info("L008:"+cert.exists());
        FileInputStream instream = new FileInputStream(cert);//加载本地的证书进行https加密传输
        log.info("L003");
        try {
    ...
    public String sendPost(String url, String xmlString,String certLocalPath,String certPassword) throws IOException, KeyStoreException, UnrecoverableKeyException, NoSuchAlgorithmException, KeyManagementException {
    	if(!hasInit){
    		log.info("req:02");
    		setRequestConfig(certLocalPath,certPassword);
    	}
