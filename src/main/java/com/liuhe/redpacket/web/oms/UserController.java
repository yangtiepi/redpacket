...
public class UserController {
	...
	@MethodAnnotation(name = "主页", type = ResourceType.微信用户)
	@RequestMapping("/index")
	private String index() {
		return "user/user";
	}

	@MethodAnnotation(name = "查询", type = ResourceType.微信用户)
	 ...
	 * @return
	 */
	@MethodAnnotation(name = "删除", type = ResourceType.微信用户)
	 ...
	 * 停用操作
	 */
	@MethodAnnotation(name = "停用", type = ResourceType.微信用户)
	 ...
	 * 启用操作
	 */
	@MethodAnnotation(name = "启用", type = ResourceType.微信用户)
	@RequestMapping("/up")
	@ResponseBody
