...
$(function(){
   ...
   //数据表格
	...
	<!-- 新增或编辑表格 -->
	<div id="employeeDialog" class="easyui-dialog" style="width: 300px;height: 250px;padding: 20px;"
		data-options="modal:true,title:'修改密码',iconCls:'icon-edit',buttons:'#employee_bs',closed:true" >
		<form id="employeeForm"  method="post">
			<input type="hidden" name="id">
			 <div style="margin-top: 10px;">
			 	原密码&emsp;：<input type="text" name="oldPassword"  class="easyui-textbox" data-options="required:true">
			 </div>
			 <div style="margin-top: 10px;">
			 	新密码&emsp;：<input type="text" id="password"  name="password"  class="easyui-textbox" data-options="required:true">
			 </div>
			 <div style="margin-top: 10px;">
